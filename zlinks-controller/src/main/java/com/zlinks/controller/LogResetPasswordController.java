...
public class LogResetPasswordController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = logResetPasswordService.delete(logResetPassword);
	...
	/**
     * @api {post} /logResetPasswords/save 02. LogResetPassword详细信息
     * @apiPermission Login in Users
     * @apiGroup  LogResetPassword
     * @apiVersion 1.0.1
	...
	public JsonResult info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			LogResetPassword entity  = logResetPasswordService.queryInfoById(id);
	...
	/**
     * @api {post} /logResetPasswords/list 03. LogResetPassword列表查询
     * @apiPermission Login in Users
     * @apiGroup  LogResetPassword
     * @apiVersion 1.0.1
     ...
     * }
     */
	@RequestMapping(value = "/logResetPasswords/list")
	...
	/**
     * @api {post} /logResetPasswords/save 03. LogResetPassword新增
     * @apiPermission Login in Users
     * @apiGroup  LogResetPassword
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> LogResetPassword的prop.propertyName
	...
	public JsonResult add(@RequestBody LogResetPassword logResetPassword) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = logResetPasswordService.add(logResetPassword);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	/**
     * @api {post} /logResetPasswords/update/{id} 03. LogResetPassword修改
     * @apiPermission Login in Users
     * @apiGroup  LogResetPassword
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> LogResetPassword的prop.propertyName
     ...
     * }
     */
	@RequestMapping(value = "/logResetPasswords/save", method = RequestMethod.PUT)
	public JsonResult add(@RequestBody LogResetPassword logResetPassword) {
