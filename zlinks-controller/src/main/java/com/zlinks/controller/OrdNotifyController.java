...
import com.zlinks.domain.OrdNotify;
import com.zlinks.service.OrdNotifyService;
...
public class OrdNotifyController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = ordNotifyService.delete(ordNotify);
	...
	/**
     * @api {post} /ordNotifys/save 02. OrdNotify详细信息
     * @apiPermission Login in Users
     * @apiGroup  OrdNotify
     * @apiVersion 1.0.1
	...
	public JsonResult info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			OrdNotify entity  = ordNotifyService.queryInfoById(id);
	...
	/**
     * @api {post} /ordNotifys/list 03. OrdNotify列表查询
     * @apiPermission Login in Users
     * @apiGroup  OrdNotify
     * @apiVersion 1.0.1
     ...
     * }
     */
	@RequestMapping(value = "/ordNotifys/list")
	...
	/**
     * @api {post} /ordNotifys/save 03. OrdNotify新增
     * @apiPermission Login in Users
     * @apiGroup  OrdNotify
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> OrdNotify的prop.propertyName
	...
	public JsonResult add(@RequestBody OrdNotify ordNotify) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = ordNotifyService.add(ordNotify);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	/**
     * @api {post} /ordNotifys/update/{id} 03. OrdNotify修改
     * @apiPermission Login in Users
     * @apiGroup  OrdNotify
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> OrdNotify的prop.propertyName
     ...
     * }
     */
	@RequestMapping(value = "/ordNotifys/save", method = RequestMethod.PUT)
	public JsonResult add(@RequestBody OrdNotify ordNotify) {
