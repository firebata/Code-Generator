...
import com.zlinks.zlinks-repository/src/main/java/com/zlinks/domain/.HisUsrGmeAccLvl;
import com.zlinks.zlinks-service/src/main/java/com/zlinks/service/.HisUsrGmeAccLvlService;
...
*/
@Controller
@RequestMapping("/hisUsrGmeAccLvl")
public class HisUsrGmeAccLvlController extends BaseController {

	/**
	 * logger 日志
	 */
	private static final Logger logger = LoggerFactory.getLogger(HisUsrGmeAccLvlController.class);
	
	private static final String BASE_PATH = "hisUsrGmeAccLvl/";
	...
	public HttpResult<Integer> deleteJson(@PathVariable("id") int id) {
		...
		try {
			int row = hisUsrGmeAccLvlService.delete(id);
	...
	public String view(@PathVariable("id") int id, ModelMap modelMap) {
		try {
			HisUsrGmeAccLvl entity = hisUsrGmeAccLvlService.getById(id);
	...
	@ResponseBody
	public HttpResult<Pagination<HisUsrGmeAccLvl>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		HttpResult<Pagination<HisUsrGmeAccLvl>> result = new HttpResult<Pagination<HisUsrGmeAccLvl>>();
		try {
			Pagination<HisUsrGmeAccLvl> data = hisUsrGmeAccLvlService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
