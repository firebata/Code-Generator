...
public class HisUsrGmeAccLvlController extends BaseController {
	...
	/**
     * @api {post} /hisUsrGmeAccLvls/save 01. HisUsrGmeAccLvl新增
	...
	public JsonResult add(@RequestBody HisUsrGmeAccLvl hisUsrGmeAccLvl) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = hisUsrGmeAccLvlServiceImpl.add(hisUsrGmeAccLvl);
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = hisUsrGmeAccLvlServiceImpl.delete(hisUsrGmeAccLvl);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	public String info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			HisUsrGmeAccLvl entity  = hisUsrGmeAccLvlServiceImpl.queryInfoById(id);
	...
	@ResponseBody
	public JsonResult<Pagination<HisUsrGmeAccLvl>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		JsonResult<Pagination<HisUsrGmeAccLvl>> result = new JsonResult<Pagination<HisUsrGmeAccLvl>>();
		try {
			Pagination<HisUsrGmeAccLvl> data = hisUsrGmeAccLvlService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
