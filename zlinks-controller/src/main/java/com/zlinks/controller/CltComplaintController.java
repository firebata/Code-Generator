...
import com.zlinks.domain.CltComplaint;
import com.zlinks.service.CltComplaintService;
...
public class CltComplaintController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = cltComplaintService.delete(cltComplaint);
	...
	/**
     * @api {post} /cltComplaints/save 02. CltComplaint详细信息
     * @apiPermission Login in Users
     * @apiGroup  CltComplaint
     * @apiVersion 1.0.1
	...
	public JsonResult info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			CltComplaint entity  = cltComplaintService.queryInfoById(id);
	...
	/**
     * @api {post} /cltComplaints/list 03. CltComplaint列表查询
     * @apiPermission Login in Users
     * @apiGroup  CltComplaint
     * @apiVersion 1.0.1
     ...
     * }
     */
	@RequestMapping(value = "/cltComplaints/list")
	...
	/**
     * @api {post} /cltComplaints/save 03. CltComplaint新增
     * @apiPermission Login in Users
     * @apiGroup  CltComplaint
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> CltComplaint的prop.propertyName
	...
	public JsonResult add(@RequestBody CltComplaint cltComplaint) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = cltComplaintService.add(cltComplaint);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	/**
     * @api {post} /cltComplaints/update/{id} 03. CltComplaint修改
     * @apiPermission Login in Users
     * @apiGroup  CltComplaint
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> CltComplaint的prop.propertyName
     ...
     * }
     */
	@RequestMapping(value = "/cltComplaints/save", method = RequestMethod.PUT)
	public JsonResult add(@RequestBody CltComplaint cltComplaint) {
