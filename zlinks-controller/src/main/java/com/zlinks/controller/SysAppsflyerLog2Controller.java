...
public class SysAppsflyerLog2Controller extends BaseController {
	...
	/**
     * @api {post} /sysAppsflyerLog2s/save 01. SysAppsflyerLog2新增
	...
	public JsonResult add(@RequestBody SysAppsflyerLog2 sysAppsflyerLog2) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = sysAppsflyerLog2ServiceImpl.add(sysAppsflyerLog2);
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = sysAppsflyerLog2ServiceImpl.delete(sysAppsflyerLog2);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	public String info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			SysAppsflyerLog2 entity  = sysAppsflyerLog2ServiceImpl.queryInfoById(id);
	...
	@ResponseBody
	public JsonResult<Pagination<SysAppsflyerLog2>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		JsonResult<Pagination<SysAppsflyerLog2>> result = new JsonResult<Pagination<SysAppsflyerLog2>>();
		try {
			Pagination<SysAppsflyerLog2> data = sysAppsflyerLog2Service.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
