...
public class UserInfoController extends BaseController {
	...
	private static final String BASE_PATH = "userInfo/";
	...
	public HttpResult<Integer> deleteJson(@PathVariable("id") int id) {
		...
		try {
			int row = userInfoService.delete(id);
	...
	@ResponseBody
	public HttpResult<Pagination<UserInfo>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		HttpResult<Pagination<UserInfo>> result = new HttpResult<Pagination<UserInfo>>();
		try {
			Pagination<UserInfo> data = userInfoService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
