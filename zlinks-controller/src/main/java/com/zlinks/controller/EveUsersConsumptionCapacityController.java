...
import com.zlinks.zlinks-repository/src/main/java/com/zlinks/domain/.EveUsersConsumptionCapacity;
import com.zlinks.zlinks-service/src/main/java/com/zlinks/service/.EveUsersConsumptionCapacityService;
...
*/
@Controller
@RequestMapping("/eveUsersConsumptionCapacity")
public class EveUsersConsumptionCapacityController extends BaseController {

	/**
	 * logger 日志
	 */
	private static final Logger logger = LoggerFactory.getLogger(EveUsersConsumptionCapacityController.class);
	
	private static final String BASE_PATH = "eveUsersConsumptionCapacity/";
	...
	public HttpResult<Integer> deleteJson(@PathVariable("id") int id) {
		...
		try {
			int row = eveUsersConsumptionCapacityService.delete(id);
	...
	public String view(@PathVariable("id") int id, ModelMap modelMap) {
		try {
			EveUsersConsumptionCapacity entity = eveUsersConsumptionCapacityService.getById(id);
	...
	@ResponseBody
	public HttpResult<Pagination<EveUsersConsumptionCapacity>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		HttpResult<Pagination<EveUsersConsumptionCapacity>> result = new HttpResult<Pagination<EveUsersConsumptionCapacity>>();
		try {
			Pagination<EveUsersConsumptionCapacity> data = eveUsersConsumptionCapacityService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
