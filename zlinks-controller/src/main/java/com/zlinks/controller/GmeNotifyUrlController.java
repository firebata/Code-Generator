...
public class GmeNotifyUrlController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = gmeNotifyUrlService.delete(gmeNotifyUrl);
	...
	/**
     * @api {post} /gmeNotifyUrls/save 02. GmeNotifyUrl详细信息
     * @apiPermission Login in Users
     * @apiGroup  GmeNotifyUrl
     * @apiVersion 1.0.1
	...
	public JsonResult info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			GmeNotifyUrl entity  = gmeNotifyUrlService.queryInfoById(id);
	...
	/**
     * @api {post} /gmeNotifyUrls/list 03. GmeNotifyUrl列表查询
     * @apiPermission Login in Users
     * @apiGroup  GmeNotifyUrl
     * @apiVersion 1.0.1
     ...
     * }
     */
	@RequestMapping(value = "/gmeNotifyUrls/list")
	...
	/**
     * @api {post} /gmeNotifyUrls/save 03. GmeNotifyUrl新增
     * @apiPermission Login in Users
     * @apiGroup  GmeNotifyUrl
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> GmeNotifyUrl的prop.propertyName
	...
	public JsonResult add(@RequestBody GmeNotifyUrl gmeNotifyUrl) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = gmeNotifyUrlService.add(gmeNotifyUrl);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	/**
     * @api {post} /gmeNotifyUrls/update/{id} 03. GmeNotifyUrl修改
     * @apiPermission Login in Users
     * @apiGroup  GmeNotifyUrl
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> GmeNotifyUrl的prop.propertyName
     ...
     * }
     */
	@RequestMapping(value = "/gmeNotifyUrls/save", method = RequestMethod.PUT)
	public JsonResult add(@RequestBody GmeNotifyUrl gmeNotifyUrl) {
