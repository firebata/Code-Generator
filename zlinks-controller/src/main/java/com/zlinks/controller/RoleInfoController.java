...
public class RoleInfoController extends BaseController {
	...
	private static final String BASE_PATH = "roleInfo/";
	...
	public HttpResult<Integer> deleteJson(@PathVariable("id") int id) {
		...
		try {
			int row = roleInfoService.delete(id);
	...
	@ResponseBody
	public HttpResult<Pagination<RoleInfo>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		HttpResult<Pagination<RoleInfo>> result = new HttpResult<Pagination<RoleInfo>>();
		try {
			Pagination<RoleInfo> data = roleInfoService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
