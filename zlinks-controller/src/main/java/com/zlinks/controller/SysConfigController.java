...
public class SysConfigController extends BaseController {
	...
	private static final String BASE_PATH = "sysConfig/";
	...
	public HttpResult<Integer> deleteJson(@PathVariable("id") int id) {
		...
		try {
			int row = sysConfigService.delete(id);
	...
	@ResponseBody
	public HttpResult<Pagination<SysConfig>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		HttpResult<Pagination<SysConfig>> result = new HttpResult<Pagination<SysConfig>>();
		try {
			Pagination<SysConfig> data = sysConfigService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
