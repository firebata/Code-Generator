...
import com.zlinks.domain.OrdPay;
import com.zlinks.service.OrdPayService;
...
public class OrdPayController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = ordPayService.delete(ordPay);
	...
	/**
     * @api {post} /ordPays/save 02. OrdPay详细信息
     * @apiPermission Login in Users
     * @apiGroup  OrdPay
     * @apiVersion 1.0.1
	...
	public JsonResult info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			OrdPay entity  = ordPayService.queryInfoById(id);
	...
	/**
     * @api {post} /ordPays/list 03. OrdPay列表查询
     * @apiPermission Login in Users
     * @apiGroup  OrdPay
     * @apiVersion 1.0.1
     ...
     * }
     */
	@RequestMapping(value = "/ordPays/list")
	...
	/**
     * @api {post} /ordPays/save 03. OrdPay新增
     * @apiPermission Login in Users
     * @apiGroup  OrdPay
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> OrdPay的prop.propertyName
	...
	public JsonResult add(@RequestBody OrdPay ordPay) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = ordPayService.add(ordPay);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	/**
     * @api {post} /ordPays/update/{id} 03. OrdPay修改
     * @apiPermission Login in Users
     * @apiGroup  OrdPay
     * @apiVersion 1.0.1
	 * @apiParam {BigInteger} prop.propertyName <code>必须参数</code> OrdPay的prop.propertyName
     ...
     * }
     */
	@RequestMapping(value = "/ordPays/save", method = RequestMethod.PUT)
	public JsonResult add(@RequestBody OrdPay ordPay) {
