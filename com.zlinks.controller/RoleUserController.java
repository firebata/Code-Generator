...
import com.zlinks.com.zlinks.domain.RoleUser;
import com.zlinks.com.zlinks.service.RoleUserService;
...
public class RoleUserController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = roleUserServiceImpl.delete(roleUser);
	...
	public String info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			RoleUser entity  = roleUserServiceImpl.queryInfoById(id);
	...
	/**
     * @api {post} /roleUsers/save 01. RoleUser新增
     * @apiPermission Login in Users
     * @apiGroup  RoleUser
     * @apiVersion 1.0.1
	...
	public JsonResult add(@RequestBody RoleUser roleUser) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = roleUserServiceImpl.add(roleUser);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	@ResponseBody
	public JsonResult<Pagination<RoleUser>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		JsonResult<Pagination<RoleUser>> result = new JsonResult<Pagination<RoleUser>>();
		try {
			Pagination<RoleUser> data = roleUserService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
