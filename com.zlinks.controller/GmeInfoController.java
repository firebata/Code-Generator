...
import com.zlinks.com.zlinks.domain.GmeInfo;
import com.zlinks.com.zlinks.service.GmeInfoService;
...
public class GmeInfoController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = gmeInfoServiceImpl.delete(gmeInfo);
	...
	public String info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			GmeInfo entity  = gmeInfoServiceImpl.queryInfoById(id);
	...
	/**
     * @api {post} /gmeInfos/save 01. GmeInfo新增
     * @apiPermission Login in Users
     * @apiGroup  GmeInfo
     * @apiVersion 1.0.1
	...
	public JsonResult add(@RequestBody GmeInfo gmeInfo) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = gmeInfoServiceImpl.add(gmeInfo);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	@ResponseBody
	public JsonResult<Pagination<GmeInfo>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		JsonResult<Pagination<GmeInfo>> result = new JsonResult<Pagination<GmeInfo>>();
		try {
			Pagination<GmeInfo> data = gmeInfoService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
