...
import com.zlinks.com.zlinks.domain.CusAppPackageReport;
import com.zlinks.com.zlinks.service.CusAppPackageReportService;
...
public class CusAppPackageReportController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = cusAppPackageReportServiceImpl.delete(cusAppPackageReport);
	...
	public String info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			CusAppPackageReport entity  = cusAppPackageReportServiceImpl.queryInfoById(id);
	...
	/**
     * @api {post} /cusAppPackageReports/save 01. CusAppPackageReport新增
     * @apiPermission Login in Users
     * @apiGroup  CusAppPackageReport
     * @apiVersion 1.0.1
	...
	public JsonResult add(@RequestBody CusAppPackageReport cusAppPackageReport) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = cusAppPackageReportServiceImpl.add(cusAppPackageReport);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	@ResponseBody
	public JsonResult<Pagination<CusAppPackageReport>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		JsonResult<Pagination<CusAppPackageReport>> result = new JsonResult<Pagination<CusAppPackageReport>>();
		try {
			Pagination<CusAppPackageReport> data = cusAppPackageReportService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
