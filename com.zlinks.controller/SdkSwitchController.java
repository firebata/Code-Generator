...
import com.zlinks.com.zlinks.domain.SdkSwitch;
import com.zlinks.com.zlinks.service.SdkSwitchService;
...
public class SdkSwitchController extends BaseController {
	...
	public JsonResult deleteJson(@PathVariable("id") int id) {
		RestDoing doing = jsonResult -> {
            ...
            int counts = sdkSwitchServiceImpl.delete(sdkSwitch);
	...
	public String info(@PathVariable("id") Long id) {
		...
		RestDoing doing = jsonResult -> {
			...
			SdkSwitch entity  = sdkSwitchServiceImpl.queryInfoById(id);
	...
	/**
     * @api {post} /sdkSwitchs/save 01. SdkSwitch新增
     * @apiPermission Login in Users
     * @apiGroup  SdkSwitch
     * @apiVersion 1.0.1
	...
	public JsonResult add(@RequestBody SdkSwitch sdkSwitch) {
  		...
  		RestDoing doing = jsonResult -> {
            ...
            int counts = sdkSwitchServiceImpl.add(sdkSwitch);
            jsonResult.data = counts;
        };
        return doing.go(request, logger);
	}
	...
	@ResponseBody
	public JsonResult<Pagination<SdkSwitch>> jsonList(String findContent, ModelMap modelMap, Integer pageNo) {
		JsonResult<Pagination<SdkSwitch>> result = new JsonResult<Pagination<SdkSwitch>>();
		try {
			Pagination<SdkSwitch> data = sdkSwitchService.findPage(modelMap, pageNo, pageSize);
			result.setData(data);
		} catch (Exception e) {
