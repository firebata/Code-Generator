...
public class SysConfigKeyConstant {
    ...
    public final static String SMS_GW_ACTIVE = "active";

    public final static String SMS_TPL_TW = "886";

    public final static String SMS_TPL_HK = "852";

    //韩国
    public final static String SMS_TPL_KR = "82";

    //新加坡
    public final static String SMS_TPL_SG = "65";

    //马来西亚
    public final static String SMS_TPL_MY = "60";

    //日本
    public final static String SMS_TPL_JP = "81";

    //国内
    public final static String SMS_TPL_CN = "86";

    public final static String COMMON_KEY = "key";

    //
    public final static String IP_KEY = "ip";

    public final static String SMS_REGION_CN = "CN";

    public final static String SMS_REGION_TW = "TW";

    public final static String SMS_REGION_KR = "KR";
